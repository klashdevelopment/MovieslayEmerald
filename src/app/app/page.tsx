        ...
        <PageLayout>
            <div className="flex flex-col align full-w h-90 gap-05 py-20">
                ...
                <div className="w-[40rem] h-auto relative">
                    ...
                    <div className="absolute inset-x-20 top-0 bg-gradient-to-r from-transparent via-blue-200 to-transparent h-px w-3/4" />
                    ...
                    /> */}
                    <div className="absolute inset-0 w-full h-full bg-[#0b0d0e] [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
                </div>
