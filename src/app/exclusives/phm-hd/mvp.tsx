...
export default function ProjectHailMaryPage({movie}: {movie: Exclusive}) {
            ...
            <PageLayout title={`${movie ? movie.title : 'Movie'}`}>
                <div className={`flex align flex-col ${fullscreen ? '' : 'gap-05'} movie-page${fullscreen ? ' fullscreen' : ''}`} style={{ gap: `${fullscreen ? '0px' : '1rem'}` }}>
                    {<>
                        ...
                        {/* <video src="http://n1.eclipsesystems.org:25043/content.mp4" controls autoPlay className="movie-source" /> */}
                        <iframe src={`/exclusives/phm-hd/internal`} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
